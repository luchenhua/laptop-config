...
cd ~/dev/repo/work/msghub-be-filter-java && pwd && git fetch --all --prune && git switch main && git pull && git switch develop && git pull;
...
cd ~/dev/repo/work/msghub-mq-wechat-java && pwd && git fetch --all --prune && git switch main && git pull && git switch develop && git pull;
